  ...
  return (
    ...
    >
      ...
      <Col>
        ...
        <p>{content}</p>
        <Image src={imageUrl} style={{ maxWidth: 150 }} />
        <div className="d-flex justify-content-between">
          ...
          <UpdaatePostModal show={showUpdateModal} handleClose={handleCloseUpdateModal} postId={postId} originalPostContent={content} />
        </div>
      </Col>
    </Row>
  );
